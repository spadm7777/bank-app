...
"""
Admin의 2025.07.27 수수료 로그를 수정하는 스크립트 (v2)
"""
...
def fix_admin_fee_log_v2():
    """Admin의 2025.07.27 수수료 로그를 수정합니다."""
    
    with app.app_context():
        print("=== Admin 2025.07.27 수수료 로그 수정 (v2) ===")
        ...
        old_timestamp = target_log.timestamp
        ...
        print(f"  시간: {old_timestamp.strftime('%H:%M:%S')} → 00:00:00")

if __name__ == '__main__':
    fix_admin_fee_log_v2() 