...
"""
Admin의 2025.07.27 수수료 로그를 수정하는 스크립트
"""
...
def fix_admin_fee_log():
    ...
    with app.app_context():
        ...
        # 2025.07.27 15:32:35 로그 찾기
        target_date = datetime(2025, 7, 27, 15, 32, 35)
        ...
        if not target_log:
            print("❌ 2025.07.27 15:32 로그를 찾을 수 없습니다.")
            return
